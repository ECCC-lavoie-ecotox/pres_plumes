...
---
# Obtenir les mesures de contaminants pour un site

Afin de simplifier les étapes de jointures entre les tables, il existe une fonction générique dans le package qui permet de récupérer l'ensemble des entrées dans la base de données. On peut par la suite filtrer pour obtenir seulement les mesures désirées.
