...
```{R}
db_plumes <- plumesbox::get_db(con) |> head(100) |> as.data.frame()
```
...
```{R}
db_plumes <- plumesbox::get_db(con)
...
Ensuite, les données de terrain :
 ...
 - **field_sample** : Relier à sites, species et capture, donc ces tables doivent être déjà remplies.
...
https://eccc-lavoie-ecotox.github.io/plumesbox/articles/import-MET-THg-23-19.html
...
## Reprendre la recette d'importation et l'appliquer à un autre rapport de laboratoire 
